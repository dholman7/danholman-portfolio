"""
Comprehensive regression tests for ai-test-generation module.
...
from ai_test_generation.core import GuidanceTemplate, GuidanceItem, GuidanceTemplateMetadata
from ai_test_generation.renderers import CursorRenderer, CopilotRenderer
from ai_test_generation.cli import main as cli_main
