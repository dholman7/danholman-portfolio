...
from ai_test_generation.cli import main
...
class TestCLIIntegration:
    ...
    def test_cli_help_command(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "ai_test_generation.cli", "--help"],
            capture_output=True,
            text=True
        )
    ...
    @patch('ai_test_generation.cli.CursorRenderer')
    @patch('ai_test_generation.cli.CopilotRenderer')
    ...
    def test_cli_with_invalid_command(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "ai_test_generation.cli", "invalid-command"],
            capture_output=True,
            text=True
        )
