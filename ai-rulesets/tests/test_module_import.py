"""
Simple test to ensure the ai_rulesets module can be imported.
...
class TestModuleImport:
    """Test that the ai_rulesets module can be imported and used."""

    @allure.story("Module Import")
    @allure.title("Import ai_rulesets module")
    @allure.description("Test that the ai_rulesets module can be imported successfully.")
