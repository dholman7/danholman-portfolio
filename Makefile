...
allure-serve: ## Serve Allure reports locally for all modules
	...
	@echo "  - AI Test Generation: http://localhost:5052/ai-rulesets"
	@echo ""
...
allure-serve-single: ## Serve Allure reports for a specific module (usage: make allure-serve-single MODULE=automation-framework)
	@if [ -z "$(MODULE)" ]; then \
		...
		echo "Available modules: automation-framework, cloud-native-app, ai-rulesets"; \
		exit 1; \
	fi
...
allure-history: ## Copy Allure history for trend analysis
	...
	@mkdir -p allure-history/automation-framework allure-history/ai-rulesets allure-history/cloud-native-app
...
allure-docker-serve: allure-results ## Serve Allure reports using Docker (no Java required)
	...
	@echo "Press Ctrl+C to stop all servers"
	@trap 'docker stop allure-automation-framework allure-ai-rulesets allure-cloud-native-app && docker rm allure-automation-framework allure-ai-rulesets allure-cloud-native-app' INT
	@wait
...
allure-docker-clean: ## Clean Docker-based Allure containers
	...
	@docker stop allure-automation-framework allure-ai-rulesets allure-cloud-native-app 2>/dev/null || true
	@docker rm allure-automation-framework allure-ai-rulesets allure-cloud-native-app 2>/dev/null || true
...
info: ## Show portfolio information
	...
	@echo "  - ai-rulesets: AI-powered test generation using LLMs"
	@echo ""
